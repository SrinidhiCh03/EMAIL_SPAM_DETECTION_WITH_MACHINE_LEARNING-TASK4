...
Original file is located at
    https://colab.research.google.com/drive/1eSfduLShSAl-TxTwUsjRLTOL8ltQCg-6
"""
...
df.drop(columns=['doornumber','aspiration' ,'symboling' ,'doornumber','enginelocation'], inplace=True, axis=1)
